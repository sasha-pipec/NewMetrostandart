# Generated by Django 4.0 on 2023-11-13 16:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='models_app.subtype', verbose_name='Подтип')),
            ],
            options={
                'verbose_name': 'Тип',
        ...
        migrations.AddField(
            model_name='device',
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='models_app.type', verbose_name='Подтип'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
